...
<div class="container-fluid">
			...
			<div class="sidebar-sticky pt-3">
				<ul class="nav flex-column">
					...
					<ul class="list-unstyled mb-0">
						<li><a href="/"
							class="dropdown-item d-flex align-items-center gap-2 py-2 bg-light text-primary">
  ...
  <path
						...
						<li><a
							class="dropdown-item d-flex align-items-center gap-2 py-2 text-gray-darktext-primary"
  ...
  <path
							...
							<div
								...
								<div
									...
									<strong class="text-gray-dark fs-2">${board.title}</strong>
									<strong class="text-gray-dark fs-2">${board.creatDate}</strong>
